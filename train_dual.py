...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='/root/YOLOv9new/datasets/v9test.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / '/root/YOLOv9new/datasets/data.yaml', help='dataset.yaml path')
    parser.add_argument('--hyp', type=str, default=ROOT / '/root/YOLOv9new/datasets/hyp.yaml', help='hyperparameters path')
