...
from models.backbone.lsknet import LSKblockAttention
from  models.block.DRANet import *
from models.DEANet  import CGAFusion
...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in {
            ...
            ELAN1, RepNCSPELAN4, SPPELAN,RAB, CoordAtt}:
            c2 = ch[f]
            args = [c2, *args]
